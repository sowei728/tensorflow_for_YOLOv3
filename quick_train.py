...
train_tfrecord   = "./apple_dataset/apple_train.tfrecords"
...
for step in range(STEPS):
    ...
    # print("=> STEP %10d [TRAIN]:\tloss_xy:%7.4f \tloss_wh:%7.4f \tloss_conf:%7.4f"
    #       % (step + 1, run_items[5], run_items[6], run_items[7]))
